                ...
                <div class="card-body">
                    <div>
                        <div class="text-center">
                            ...
                            {{-- <a href="{{$ranking->kebersihan}}">Tes</a> --}}
                            <button class="btn btn-primary" data-uid="{{ $ranking->uid_ranking }}"
                                data-kebersihan="{{ $ranking->kebersihan }}"
                                data-solidaritas="{{ $ranking->solidaritas }}"
                                data-royalitas="{{$ranking->royalitas}}"
                                data-omset="{{$ranking->omset}}"
                                data-bs-toggle="modal"
                                data-bs-target="#myRanking">Edit</button>
                        </div>
                        @include('admin.partial.modal.update-ranking')
                    </div>
                </div>
                <!--end card body-->
            </div>
